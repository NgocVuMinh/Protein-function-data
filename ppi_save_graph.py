...
def main(prefix):
    for ont in ["mf", "bp", "cc"]:
        train_df = pd.read_pickle(f"data/{ont}/{prefix}_train.pkl")
        ...
        valid_df = pd.read_pickle(f"data/{ont}/{prefix}_valid.pkl")
        ...
        test_df = pd.read_pickle(f"data/{ont}/{prefix}_test.pkl")
        ...
        dgl.save_graphs(
            f"data/{ont}/{prefix}_ppi_test.bin", graph,
            {
